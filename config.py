class config:
	...
	def jesse_edsr_lsgan(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_wgan_v1_trial_v3" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
	...
	def edsr_lsgan_up(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_up_full_v1" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
	...
	def edsr_wgan_encode(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_wgan_encode_v1" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_wgan_encode" # Name of checkpoints
		...
		eval_config["dataroot"] = '/home/ubuntu/dataset/SuperResolution/'
		eval_config["test_set"] = ["Set5"]
		eval_config["models"] = [edsr_wgan_encode(self)]
		eval_config["summary_file"] = "example_summary.txt"

	def edsr_lsgan_recursive(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_recursive_v1_l110" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_lsgan_recursive" # Name of checkpoints

		def edsr_lsgan_recursive(self):
						
			mconfig = {}
			
			mconfig["edsr_lsgan_recursive"] = {
		...
		eval_config["dataroot"] = '/home/ubuntu/dataset/SuperResolution/'
		eval_config["test_set"] = ["Set5"]
		eval_config["models"] = [edsr_lsgan_recursive(self)]
		eval_config["summary_file"] = "example_summary.txt"

	def edsr_lsgan_lap(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_lap_v2" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_lsgan_lap" # Name of checkpoints
		...
		eval_config["dataroot"] = '/home/ubuntu/dataset/SuperResolution/'
		eval_config["test_set"] = ["Set5"]
		eval_config["models"] = [edsr_lsgan_lap(self)]
		eval_config["summary_file"] = "example_summary.txt"


	def edsr_lsgan_lap_v2(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_lap_v2_lapdis" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_lsgan_lap_v2" # Name of checkpoints
	...
	def edsr_lsgan_lap_att_v2(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_lap_att_v3" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_lsgan_lap_att_v2" # Name of checkpoints
	...
	def edsr_lsgan_dis_large(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_lsgan_dis_large_v1" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_lsgan_dis_large" # Name of checkpoints
	...
	def edsr_attention_v3(self):
		...
		train_config["train_h5_name"] = "train" # Name of train dataset .h5 file
		train_config["test_h5_name"] = "test" # Name of test dataset .h5 file
		train_config["ckpt_name"] = "edsr_attention_v3_noatt" # Name of checkpoints
		train_config["is_train"] = True # True for training, False for testing [True]
		train_config["model_ticket"] = "edsr_attention_v3" # Name of checkpoints
		train_config["curr_epoch"] = 0 
	...
	def EDSR_WGAN_att_vgg_v1_x2(self):
		...
		eval_config["dataroot"] = '/home/ubuntu/dataset/SuperResolution/Set5/preprocessed_scale_1'
		eval_config["test_set"] = ["Set5"]
		eval_config["models"] = [EDSR_WGAN_att_vgg_v1_x2(self)]
		eval_config["summary_file"] = "example_summary.txt"
